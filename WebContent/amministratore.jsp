...
<title>Clinica GPMG | Profilo amministratore</title>
</head>
<body>
	<f:view>
		...
		<div class="col-sm-4">
			<ul class="list-group">
				...
				<li class="list-group-item text-right"><span class="pull-left"><strong
						class="">Nome</strong></span>${utenteController.utente.nome}</li>
				<li class="list-group-item text-right"><span class="pull-left"><strong
						class="">Cognome</strong></span>${utenteController.utente.cognome}</li>
				<li class="list-group-item text-right"><span class="pull-left"><strong
						class="">Data di nascita</strong></span>${utenteController.utente.datadinascita}</li>
				<li class="list-group-item text-right"><span class="pull-left"><strong
						class="">Codice fiscale </strong></span>${utenteController.utente.cf}</li>
				<li class="list-group-item text-right"><span class="pull-left"><strong
						class="">Sesso </strong></span>${utenteController.utente.sesso}</li>
				<li class="list-group-item text-right"><span class="pull-left"><strong
						class="">Email</strong></span>${utenteController.utente.email}</li>
			</ul>
		</div>
		<div style="clear: both;"></div>
			<div class="dropdown">
				...
				<ul class="dropdown-menu">
					<li><a href='<c:url value="/faces/newprenotazione.jsp" />'>Nuova prenotazione</a></li>
